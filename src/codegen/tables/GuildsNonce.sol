...
library GuildsNonce {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "GuildsNonce", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004775696c64734e6f6e63650000000000);
   ...
   * @notice Get nonce.
   */
  function get() internal view returns (uint256 nonce) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get nonce.
   */
  function _get() internal view returns (uint256 nonce) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set nonce.
   */
  function set(uint256 nonce) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set nonce.
   */
  function _set(uint256 nonce) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
